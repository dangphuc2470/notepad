...
export const MenuBar: React.FC = () => {
    ...
    const editMenu: MenuItem[] = [
        { label: 'Undo', shortcut: '⌘Z', icon: <IconUndo />, action: () => { setOpenMenu(null); document.execCommand('undo'); } },
        { label: 'Redo', shortcut: '⇧⌘Z', icon: <IconRedo />, action: () => { setOpenMenu(null); document.execCommand('redo'); } },
        { label: '', divider: true },
